  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Image Gallery */}
        <motion.div
          className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12 justify-items-center"
          variants={itemVariants}
        >
          <motion.div
            className="relative w-full max-w-[500px] mx-auto aspect-square rounded-xl overflow-hidden lg:ml-26"
          ...
          >
            <Image
              ...
              priority={activeImage === 0} // Prioritize first image
            />
          </motion.div>
          <div className="flex flex-row lg:flex-col gap-4 justify-center lg:mr-48">
        ...
        {/* Product Details */}
        <motion.div
          className="bg-white rounded-xl p-6 shadow-lg mx-auto max-w-3xl"
          variants={itemVariants}
        >
        ...
        {/* Related Products */}
        <motion.div className="mt-12 max-w-7xl mx-auto" variants={itemVariants}>
